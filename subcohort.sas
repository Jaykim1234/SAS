...
/*SAS.BR_NCS_09_10_ALL 전체데이터*/
/*SAS.TEMP는 70%데이터/ SAS.TEMP_70는 C50,D05보정 DATA*/
/*SAS.TEMP_30는 30%데이터/ SAS.TEST_30는 C50,D05보정 DATA*/
...
IF MNS_YN_1=1 THEN MNS_YN_2=0;
ELSE MNS_YN_2=1; RUN;
PROC FREQ DATA=SAS.TEMP_TEST3; TABLE MNS_YN_2; RUN;/*MNS_YN_2=0 1174182개, MNS_YN_2=1 1324995개*/
...
else output MNS1; run; /*SAS.MNS0은(는) 1174182개, SAS.MNS1은(는) 1324995개*/
...
else output TEST_MNS1; run; /*SAS.TEST_MNS0은(는) 1174182개, SAS.TEST_MNS1은(는) 1324995개*/
/*폐경전*/
...
else output SAS.TEST1_MNS1; run; /*SAS.TEST1_MNS0은(는) 1174182개, SAS.TEST1_MNS1은(는) 1324995개*/
...
else output SAS.TEST2_MNS1; run; /*SAS.TEST2_MNS0은(는) 1159442개, SAS.TEST2_MNS1은(는) 1313974개*/
