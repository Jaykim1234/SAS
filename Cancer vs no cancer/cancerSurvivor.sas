libname A 'D:\원본 2\raw';
libname B 'D:\원본 2\result';
...
proc freq data=b.thesis;  tables DS1_AGE1*group/chisq; run;
/***나이(평균 및 표준편차)univariate***/
proc univariate data=b.thesis ; class group; var cage; run;
proc univariate data=b.thesis ; var cage; run;
/***나이(평균 및 표준편차)ttest***/
proc ttest data=b.thesis; class group; var cage; run;
...
proc freq data=b.thesis; where group=0;tables DS1_SEX1/list missing; run;
proc freq data=b.thesis; where group=1;tables DS1_SEX1/list missing; run;
proc freq data=b.thesis;  tables DS1_SEX1*group/chisq; run;
...
proc freq data= b.thesis; where group=0;tables DS1_MARRY_A_1/list missing; run;
proc freq data= b.thesis; where group=1;tables DS1_MARRY_A_1/list missing; run;
proc freq data= b.thesis; tables DS1_MARRY_A_1*group/chisq; run;	
...
proc freq data=b.thesis; tables DS1_EDU*group/chisq; run;
proc freq data=b.thesis; where group=0;tables DS1_EDU1/list missing; run;
proc freq data=b.thesis; where group=1;tables DS1_EDU1/list missing; run;
proc freq data=b.thesis; tables DS1_EDU1*group/chisq; run;
proc freq data=b.thesis; tables DS1_EDU2*group/chisq; run;
...
proc freq data=b.thesis; where group=0;tables DS1_INCOME/list missing; run;
proc freq data=b.thesis; where group=1;tables DS1_INCOME/list missing; run;
proc freq data=b.thesis; tables DS1_INCOME1*group/chisq; run; 	  /* 1=50만원 미만, 2=50-100만원 미만, 3=100-150만원 미만, 4=150-200만원 미만, 5=200-300만원 미만, 6=300-400만원 미만, 7=400-600만원 미만, 8=600만원 이상 */		
proc freq data=b.thesis; tables DS1_INCOME2*group/chisq; run; 	  /* 1=50만원 미만, 2=50-100만원 미만, 3=100-150만원 미만, 4=150-200만원 미만, 5=200-300만원 미만, 6=300-400만원 미만, 7=400-600만원 미만, 8=600만원 이상 */		
...
proc freq data=b.thesis; where group=0;tables DS1_JOB_1/list missing; run;
proc freq data=b.thesis; where group=1;tables DS1_JOB_1/list missing; run;
proc freq data=b.thesis; tables DS1_JOB_1*group/chisq; run;	
...
proc freq data=b.thesis; where group=0; tables psmok/list missing; run;
proc freq data=b.thesis; where group=1; tables psmok/list missing; run;
proc freq data=b.thesis;  tables psmok*group/chisq; run;
proc freq data=b.thesis; where psmok^=99 ; tables psmok*group/chisq; run;
...
run; 
proc freq data=b.thesis; where group=0; tables gexer_wk2/list missing; run;
proc freq data=b.thesis; where group=1; tables gexer_wk2/list missing; run;
proc freq data=b.thesis; tables gexer_wk2*group/chisq; run;
...
run;			
proc freq data=b.thesis; where group=0;tables gbmi2/list missing; run;
proc freq data=b.thesis; where group=1;tables gbmi2/list missing; run;
proc freq data=b.thesis;  tables gbmi2*group/chisq; run;
...
run;
proc freq data=b.thesis; tables PWI_1; run;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
proc freq data=b.thesis; where group=0; tables PWI_1; run;
proc freq data=b.thesis; where group=1; tables PWI_1; run;
proc freq data=b.thesis;  tables PWI_1*group/chisq; run;	
proc univariate data=b.thesis ; where PWI^=99999; class group; var PWI; run;
proc ttest data=b.thesis; where PWI^=99999;  class group; var PWI; run; 	
...
proc freq data=b.thesis; tables MeS * group/chisq; run;

proc freq data=b.thesis; where wc ^= 99; tables wc * group/chisq; run;
proc univariate data=b.thesis; where wc ^= 99; class group; var cwaist; run;
proc freq data=b.thesis; where tg ^= 99; tables tg * group/chisq; run;
proc univariate data=b.thesis; where tg ^= 99; class tg; var ds1_tg1; run;
proc freq data=b.thesis; where hdl ^= 99; tables hdl * group/chisq; run;
proc univariate data=b.thesis; where hdl ^= 99; class hdl; var ds1_hdl1; run;
proc freq data=b.thesis; where bp ^= 99; tables bp * group/chisq; run;
...
proc freq data=b.thesis; where glu ^= 99; tables glu * group/chisq; run;
proc univariate data=b.thesis; where glu ^= 99; class glu; var ds1_glu0_1; run;

proc ttest data=b.thesis; where cwaist^=99999; class group; var cwaist; run; 
proc ttest data=b.thesis; where DS1_TG1^=99999; class group; var DS1_TG1; run; 
proc ttest data=b.thesis; where DS1_HDL1^=99999; class group; var DS1_HDL1; run; 
proc ttest data=b.thesis; where DS1_SBP1^=99999; class group; var DS1_SBP1; run; 
proc ttest data=b.thesis; where DS1_DBP1^=99999; class group; var DS1_DBP1; run; 
proc ttest data=b.thesis; where DS1_GLU0_1^=99999; class group; var DS1_GLU0_1; run; 

/****Chart : 전체 성별에 따라 흡연, 음주, 운동, 스트레스****/
/****(1) Smoke****/
proc freq data=b.thesis; where psmok^=99 and DS1_SEX1=1; tables psmok*group/chisq; run;
proc freq data=b.thesis; where psmok^=99 and DS1_SEX1=2; tables psmok*group/chisq; run;
/****(2) Drink****/
proc freq data=b.thesis; where pdrink^=99 and DS1_SEX1=1; tables pdrink*group/chisq; run;
proc freq data=b.thesis; where pdrink^=99 and DS1_SEX1=2; tables pdrink*group/chisq; run;
/****(3) Gexer****/
proc freq data=b.thesis; where gexer_wk2^=99 and DS1_SEX1=1; tables gexer_wk2*group/chisq; run;
proc freq data=b.thesis; where gexer_wk2^=99 and DS1_SEX1=2; tables gexer_wk2*group/chisq; run;
/****(4) Gbmi2****/
proc freq data=b.thesis; where gbmi2^=99999 and DS1_SEX1=1; tables gbmi2*group/chisq; run;
proc freq data=b.thesis; where gbmi2^=99999 and DS1_SEX1=2; tables gbmi2*group/chisq; run;
/****(5) pwi_1****/
proc freq data=b.thesis; where pwi_1^=99999 and DS1_SEX1=1; tables pwi_1*group/chisq; run;
proc freq data=b.thesis; where pwi_1^=99999 and DS1_SEX1=2; tables pwi_1*group/chisq; run;
/****(6) Totalkcal****/
proc freq data=b.thesis; where Totalkcal^=9999 and DS1_SEX1=1; tables Totalkcal*group/chisq; run;
proc freq data=b.thesis; where Totalkcal^=9999 and DS1_SEX1=2; tables Totalkcal*group/chisq; run;
/****(7) MeS****/
proc freq data=b.thesis; where DS1_SEX1=1; tables MeS*group/chisq; run;
proc freq data=b.thesis; where DS1_SEX1=2; tables MeS*group/chisq; run;
/****(8) WC****/
proc freq data=b.thesis; where wc ^= 99 and DS1_SEX1=1; tables wc*group/chisq; run;
proc freq data=b.thesis; where wc ^= 99 and DS1_SEX1=2; tables wc*group/chisq; run;
/****(9) TG****/
proc freq data=b.thesis; where TG ^= 99 and DS1_SEX1=1; tables TG*group/chisq; run;
proc freq data=b.thesis; where TG ^= 99 and DS1_SEX1=2; tables TG*group/chisq; run;
/****(10) HDL****/
proc freq data=b.thesis; where HDL ^= 99 and DS1_SEX1=1; tables HDL*group/chisq; run;
proc freq data=b.thesis; where HDL ^= 99 and DS1_SEX1=2; tables HDL*group/chisq; run;
/****(11) BP****/
proc freq data=b.thesis; where BP ^= 99 and DS1_SEX1=1; tables BP*group/chisq; run;
proc freq data=b.thesis; where BP ^= 99 and DS1_SEX1=2; tables BP*group/chisq; run;
/****(12) GLU****/
proc freq data=b.thesis; where GLU ^= 99 and DS1_SEX1=1; tables GLU*group/chisq; run;
proc freq data=b.thesis; where GLU ^= 99 and DS1_SEX1=2; tables GLU*group/chisq; run;
...
run; 
proc freq data=b.thesis; where Totalkcal^=9999; tables Totalkcal*group/chisq; run;
...
data b.thesis; set b.thesis;  
     ...
     if SS01 in (.,99999) then energy=99999;
	 else if SS01 < reference[group2] then energy=1;
	 else energy=2;
	 drop t1 - t10;
run;
...
proc freq data=b.thesis; where energy^=99999; tables energy*group/chisq; run;
...
proc freq data=b.thesis; tables Protein*group/chisq; run;
...
proc freq data=b.thesis; where sugar^=99999; tables sugar*group/chisq; run;
...
proc freq data=b.thesis; where Fiber^=99999; tables Fiber*group/chisq; run;

/* Declaration of group2 variable to analyze nutrition*/
data b.thesis; set b.thesis;
	if DS1_SEX1 = 1 and DS1_AGE < 30 then group2=1;
	else if DS1_SEX1 = 1 and DS1_AGE >= 30 and DS1_AGE < 50 then group2=2;
	else if DS1_SEX1 = 1 and DS1_AGE >= 50 and DS1_AGE < 65 then group2=3;
	else if DS1_SEX1 = 1 and DS1_AGE >= 65 and DS1_AGE < 75 then group2=4;
	else if DS1_SEX1 = 1 and DS1_AGE >= 75 then group2=5;
	else if DS1_SEX1 = 2 and DS1_AGE < 30 then group2=6;
	else if DS1_SEX1 = 2 and DS1_AGE >= 30 and DS1_AGE < 50 then group2=7;
	else if DS1_SEX1 = 2 and DS1_AGE >= 50 and DS1_AGE < 65 then group2=8;
	else if DS1_SEX1 = 2 and DS1_AGE >= 65 and DS1_AGE < 75 then group2=9;
	else group2=10; 
run;
proc freq data=b.thesis; tables group2; run;
...
data b.thesis; set b.thesis;
	...
	else if SS09 < reference[group2] then VitA=0;
	else VitA = 1;
run;
data b.thesis; set b.thesis;
	drop t1-t10;
...
proc freq data=b.thesis; where VitA^=99999; tables VitA*group/chisq; run;

/*(6) 비타민A (Old Code: Runnning Time이 너무 길어서 기존 코드 변경함)
data b.thesis; set b.thesis;
...
proc freq data=b.thesis; tables VitA2*group/chisq; run; */
...
data b.thesis; set b.thesis;
	 ...
	 else if SS11 < reference[group2] then VitB1=0;
	 else VitB1=1;
	 drop t1 - t10;
run;
proc freq data=b.thesis; tables VitB1; run;
proc freq data=b.thesis; tables VitB1*ss11/list missing;run;
proc freq data=b.thesis; where VitB1^=99999; tables VitB1*group/chisq; run;
...
data b.thesis; set b.thesis;
	 ...
	 else if SS12 < reference[group2] then VitB2=0;
	 else VitB2=1;
	 drop t1 - t10;
run;
proc freq data=b.thesis; tables VitB2; run;
proc freq data=b.thesis; tables VitB2*ss12/list missing;run;
proc freq data=b.thesis; where VitB2^=99999; tables VitB2*group/chisq; run;
...
/*(11) 니아신*/
 data b.thesis; set b.thesis;
	...
	else if SS13 < reference[group2] then Niacin=0;
	else Niacin=1;
	drop t1-t10;
run;
proc freq data=b.thesis; tables Niacin; run;
proc freq data=b.thesis; tables Niacin*ss13/list missing;run;
proc freq data=b.thesis; where Niacin^=99999; tables Niacin*group/chisq; run;
...
proc freq data=b.thesis; where Folate^=99999; tables Folate*group/chisq; run;
...
data b.thesis; set b.thesis;
	...
	else if SS16 < reference[group2] then VitB6=0;
	else VitB6=1;
	drop t1-t10;
run;
proc freq data=b.thesis; tables VitB6; run;
proc freq data=b.thesis; tables VitB6*ss16/list missing;run;
proc freq data=b.thesis; where VitB6^=99999; tables VitB6*group/chisq; run;
...
proc freq data=b.thesis; where VitC^=99999; tables VitC*group/chisq; run;
...
proc freq data=b.thesis; where VitE^=99999; tables VitE*group/chisq; run;
...
data b.thesis; set b.thesis;
	...
	else if SS05 < reference[group2] then cals=0;
	else cals=1;
	drop t1-t10;
run;
proc freq data=b.thesis; tables cals; run;
proc freq data=b.thesis; tables cals*ss05/list missing;run;
proc freq data=b.thesis; where cals^=99999; tables cals*group/chisq; run;
...
proc freq data=b.thesis; where pho^=99999; tables pho*group/chisq; run;
...
data b.thesis; set b.thesis;
	...
	else if SS07 < reference[group2] then iron=0;
	else iron=1;
	drop t1-t10;
run; 
proc freq data=b.thesis; tables iron; run;
proc freq data=b.thesis; tables iron*ss07/list missing;run;
proc freq data=b.thesis; where iron^=99999; tables iron*group/chisq; run;
...
proc freq data=b.thesis; where Cal^=99999; tables Cal*group/chisq; run;
...
data b.thesis; set b.thesis;
	...
	else if SS15 < reference[group2] then Zinc=0;
	else Zinc=1;
	drop t1-t10;
run;
proc freq data=b.thesis; tables Zinc; run;
proc freq data=b.thesis; tables Zinc*ss15/list missing;run;
proc freq data=b.thesis; where Zinc^=99999; tables Zinc*group/chisq; run;
...
data b.thesis; set b.thesis;
	...
	else if SS10 < reference[group2] then Na=0;
	else Na=1;
	drop t1-t10;
run;
proc freq data=b.thesis; tables Na; run;
proc freq data=b.thesis; tables Na*ss10/list missing;run;
proc freq data=b.thesis; where Na^=99999; tables Na*group/chisq; run;


/*****영양 ttest****/
proc ttest data=b.thesis; where SS01^=99999; class group; var SS01; run; 
proc ttest data=b.thesis; where SS02^=99999; class group; var SS02; run;
proc ttest data=b.thesis; where SS02_Per^=99999; class group; var SS02_Per; run;  
proc ttest data=b.thesis; where SS03^=99999; class group; var SS03; run; 
proc ttest data=b.thesis; where SS03_Per^=99999; class group; var SS03_Per; run; 
proc ttest data=b.thesis; where SS04^=99999; class group; var SS04; run; 
proc ttest data=b.thesis; where SS04_Per^=99999; class group; var SS04_Per; run; 
proc ttest data=b.thesis; where SS05^=99999; class group; var SS05; run; 
proc ttest data=b.thesis; where SS06^=99999; class group; var SS06; run; 
proc ttest data=b.thesis; where SS07^=99999; class group; var SS07; run; 
proc ttest data=b.thesis; where SS08^=99999; class group; var SS08; run; 
proc ttest data=b.thesis; where SS09^=99999; class group; var SS09; run; 
proc ttest data=b.thesis; where SS10^=99999; class group; var SS10; run; 
proc ttest data=b.thesis; where SS11^=99999; class group; var SS11; run; 
proc ttest data=b.thesis; where SS12^=99999; class group; var SS12; run; 
proc ttest data=b.thesis; where SS13^=99999; class group; var SS13; run; 
proc ttest data=b.thesis; where SS14^=99999; class group; var SS14; run; 
proc ttest data=b.thesis; where SS15^=99999; class group; var SS15; run; 
proc ttest data=b.thesis; where SS16^=99999; class group; var SS16; run; 
proc ttest data=b.thesis; where SS17^=99999; class group; var SS17; run; 
proc ttest data=b.thesis; where SS18^=99999; class group; var SS18; run; 
proc ttest data=b.thesis; where SS19^=99999; class group; var SS19; run; 
proc ttest data=b.thesis; where SS20^=99999; class group; var SS20; run; 
proc ttest data=b.thesis; where SS21^=99999; class group; var SS21; run; 
proc ttest data=b.thesis; where SS23^=99999; class group; var SS23; run; 
proc ttest data=b.thesis; where SS24^=99999; class group; var SS24; run; 
...
run;
proc freq data=b.thesis; table TOTAL_C*group; run; /*암 환자이나 암종 정보가 없는 경우 240명*/
...
proc freq data=b.thesis; where group=0; tables CANCER_TYPE*DS1_SEX/chisq; run;
proc freq data=b.thesis; where group=0 and psmok^=99; tables CANCER_TYPE*psmok/chisq; run;
proc freq data=b.thesis; where group=0 and pdrink^=99; tables CANCER_TYPE*pdrink/chisq; run;
proc freq data=b.thesis; where group=0 and gexer_wk2^=99; tables CANCER_TYPE*gexer_wk2/chisq; run;
proc freq data=b.thesis; where group=0 and gbmi2^=99999; tables CANCER_TYPE*gbmi2/chisq; run;
proc freq data=b.thesis; where group=0 and PWI_1^=99999; tables CANCER_TYPE*PWI_1/chisq; run;

proc freq data=b.thesis; where group=0 and energy^=99999; tables CANCER_TYPE*energy/chisq; run;
proc freq data=b.thesis; where group=0 and Protein^=99999; tables CANCER_TYPE*Protein/chisq; run;
proc freq data=b.thesis; where group=0 and fat^=99999; tables CANCER_TYPE*fat/chisq; run;
proc freq data=b.thesis; where group=0 and sugar^=99999; tables CANCER_TYPE*sugar/chisq; run;
proc freq data=b.thesis; where group=0 and Fiber^=99999; tables CANCER_TYPE*Fiber/chisq; run;
proc freq data=b.thesis; where group=0 and VitA^=99999; tables CANCER_TYPE*VitA/chisq; run;
proc freq data=b.thesis; where group=0 and VitE^=99999; tables CANCER_TYPE*VitE/chisq; run;
proc freq data=b.thesis; where group=0 and VitC^=99999; tables CANCER_TYPE*VitC/chisq; run;
proc freq data=b.thesis; where group=0 and VitB1^=99999; tables CANCER_TYPE*VitB1/chisq; run;
proc freq data=b.thesis; where group=0 and VitB2^=99999; tables CANCER_TYPE*VitB2/chisq; run;
proc freq data=b.thesis; where group=0 and Niacin^=99999; tables CANCER_TYPE*Niacin/chisq; run;
proc freq data=b.thesis; where group=0 and VitB6^=99999; tables CANCER_TYPE*VitB6/chisq; run;
proc freq data=b.thesis; where group=0 and Folate^=99999; tables CANCER_TYPE*Folate/chisq; run;
proc freq data=b.thesis; where group=0 and cals^=99999; tables CANCER_TYPE*cals/chisq; run;
proc freq data=b.thesis; where group=0 and pho^=99999; tables CANCER_TYPE*pho/chisq; run;
proc freq data=b.thesis; where group=0 and Na^=99999; tables CANCER_TYPE*Na/chisq; run;
proc freq data=b.thesis; where group=0 and Cal^=99999; tables CANCER_TYPE*Cal/chisq; run;
proc freq data=b.thesis; where group=0 and iron^=99999; tables CANCER_TYPE*iron/chisq; run;
proc freq data=b.thesis; where group=0 and Zinc^=99999; tables CANCER_TYPE*Zinc/chisq; run;
...
proc logistic data=b.thesis; where csmok not in (99);    
    ...
    model csmok (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where cdrink not in (99);    
	...
	model cdrink (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1;
...
proc logistic data=b.thesis; where gexer_wk1 not in (99);    
    ...
    model gexer_wk1 (ref='1') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where gbmi1 not in (99999);    
    ...
    model gbmi1 (ref='1') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where PWI_2 not in (99999);	   
    ...
    model PWI_2 (ref='1') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis;     
    ...
    model MeS (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.thesis; where wc not in (99);     
    ...
    model wc (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where tg not in (99);     
    ...
    model tg (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where hdl not in (99);     
    ...
    model hdl (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where bp not in (99);     
    ...
    model bp (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where glu not in (99);     
    ...
    model glu (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where energy not in (99999);    
    ...
    model energy (ref='1') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where protein not in (99999);    
    ...
    model protein (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where fat_2 not in (99999);    
    ...
    model fat_2 (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where sugar_2 not in (99999);    
    ...
    model sugar_2 (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where fiber not in (99999);    
    ...
    model fiber (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitA not in (99999);    
    ...
    model VitA (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitB1 not in (99999);    
    ...
    model VitB1 (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitB2 not in (99999);    
    ...
    model VitB2 (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Niacin not in (99999);    
    ...
    model Niacin (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Folate not in (99999);    
    ...
    model Folate (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitB6 not in (99999);    
    ...
    model VitB6 (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitC not in (99999);    
    ...
    model VitC (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitE not in (99999);    
    ...
    model VitE (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Cals not in (99999);    
    ...
    model Cals (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where pho not in (99999);    
    ...
    model pho (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where iron not in (99999);    
    ...
    model iron (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Cal not in (99999);    
    ...
    model Cal (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Zinc not in (99999);    
    ...
    model Zinc (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Na not in (99999);    
    ...
    model Na (ref='0') = group cage DS1_SEX1 DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where csmok not in (99) and DS1_SEX1=1;    
    ...
    model csmok (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where cdrink not in (99) and DS1_SEX1=1;    
	...
	model cdrink (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1;
...
proc logistic data=b.thesis; where gexer_wk1 not in (99) and DS1_SEX1=1;    
    ...
    model gexer_wk1 (ref='1') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where gbmi1 not in (99999) and DS1_SEX1=1;    
    ...
    model gbmi1 (ref='1') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where PWI_2 not in (99999) and DS1_SEX1=1;    
    ...
    model PWI_2 (ref='1') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where DS1_SEX1=1;
    ...
    model MeS (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where wc not in (99) and DS1_SEX1=1;
    ...
    model wc (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where tg not in (99) and DS1_SEX1=1;
    ...
    model tg (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where hdl not in (99) and DS1_SEX1=1;
    ...
    model hdl (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where bp not in (99) and DS1_SEX1=1;
    ...
    model bp (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where glu not in (99) and DS1_SEX1=1;
    ...
    model glu (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where energy not in (99999) and DS1_SEX1=1;    
    ...
    model energy (ref='1') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where protein not in (99999) and DS1_SEX1=1;    
    ...
    model protein (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where sugar_2 not in (99999) and DS1_SEX1=1;    
    ...
    model sugar_2 (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where fiber not in (99999)  and DS1_SEX1=1;    
    ...
    model fiber (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitA not in (99999)  and DS1_SEX1=1;    
    ...
    model VitA (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitB1 not in (99999)  and DS1_SEX1=1;    
    ...
    model VitB1 (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitB2 not in (99999)  and DS1_SEX1=1;    
    ...
    model VitB2 (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Niacin not in (99999)  and DS1_SEX1=1;    
    ...
    model Niacin (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Folate not in (99999)  and DS1_SEX1=1;    
    ...
    model Folate (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitB6 not in (99999)  and DS1_SEX1=1;    
    ...
    model VitB6 (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitC not in (99999)  and DS1_SEX1=1;    
    ...
    model VitC (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where VitE not in (99999)  and DS1_SEX1=1;    
    ...
    model VitE (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Cals not in (99999)  and DS1_SEX1=1;    
    ...
    model Cals (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where pho not in (99999)  and DS1_SEX1=1;    
    ...
    model pho (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where iron not in (99999)  and DS1_SEX1=1;    
    ...
    model iron (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Cal not in (99999)  and DS1_SEX1=1;    
    ...
    model Cal (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Zinc not in (99999)  and DS1_SEX1=1;    
    ...
    model Zinc (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where Na not in (99999)  and DS1_SEX1=1;    
    ...
    model Na (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.thesis; where DS1_SEX1=2;
    ...
    model MeS (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.thesis; where wc not in (99) and DS1_SEX1=2;
    ...
    model wc (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.thesis; where tg not in (99) and DS1_SEX1=2;
    ...
    model tg (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.thesis; where hdl not in (99) and DS1_SEX1=2;
    ...
    model hdl (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.thesis; where bp not in (99) and DS1_SEX1=2;
    ...
    model bp (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.thesis; where glu not in (99) and DS1_SEX1=2;
    ...
    model glu (ref='0') = group cage DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
/****group****/
/* group=0 : 암생존자, group=1 : 정상인(질병x),  group=2 : 정상인(질병o)**/
data b.total_final; set a.total_final_1by1; run;
proc contents data=b.total_final; run;

proc freq data=b.total_final; tables group; run; /**group0 : 5269명 group1 : 5219명 group2 : 5263명**/

/****age*****/
/***나이(평균 및 표준편차)***/
proc univariate data=b.total_final; class group; var AGE_1; run; /*group0 : 55.8 group1 : 55.6 group2 : 55.8*/
proc anova data=b.total_final; class group; model AGE_1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc freq data=b.total_final; tables DS1_AGE*DS1_AGE1/list missing;  run;/**이상없음**/
proc freq data=b.total_final; where group=0;tables DS1_AGE1/list missing; run;/* 1)50세 미만 : 1267 2)55세 미만 : 1109 3)60세 미만 : 1023 4)65세 미만 : 972 5)65세 이상 : 898 */
proc freq data=b.total_final; where group=1;tables DS1_AGE1/list missing; run;/* 1)50세 미만 : 1266 2)55세 미만 : 1109 3)60세 미만 : 1019 4)65세 미만 : 966 5)65세 이상 : 859 */
proc freq data=b.total_final; where group=2;tables DS1_AGE1/list missing; run;/* 1)50세 미만 : 1264 2)55세 미만 : 1109 3)60세 미만 : 1023 4)65세 미만 : 972 5)65세 이상 : 895 */
proc freq data=b.total_final; tables DS1_AGE1*group/chisq; run; /*p-value : 0.9991*/

/*****sex*****/
proc freq data=b.total_final; tables DS1_SEX1*group/chisq; run;/**남자 : 3940 여자 : 11581 **//*p-value : 0.9967*/
proc freq data=b.total_final; where group=0;tables DS1_SEX1/list missing; run; /**남자 : 1320 여자 : 3949 **/
proc freq data=b.total_final; where group=1;tables DS1_SEX1/list missing; run;/**남자 : 1304 여자 : 3915 **/
proc freq data=b.total_final; where group=2;tables DS1_SEX1/list missing; run;/**남자 : 1316 여자 : 3947 **/
proc freq data=b.total_final; tables DS1_SEX1*group/chisq; run; /*p-value : 0.9967*/

/****결혼****/
 /*DS1_MARRY_A_1; 미혼/별거/이혼/사별/기타 (1), 기혼/동거=결혼(2), */		
proc freq data=b.total_final; where group=0;tables DS1_MARRY_A_1/list missing; run; /*1) 미혼/별거/이혼/사별/기타 : 680 2) 결혼 : 4566 99: 23*/
proc freq data=b.total_final; where group=1;tables DS1_MARRY_A_1/list missing; run; /*1) 미혼/별거/이혼/사별/기타 : 602 2) 결혼 : 4533 99: 84*/
proc freq data=b.total_final; where group=2;tables DS1_MARRY_A_1/list missing; run; /*1) 미혼/별거/이혼/사별/기타 : 636 2) 결혼 : 4593 99: 34*/
proc freq data=b.total_final; tables DS1_MARRY_A_1*group/chisq; run;/*p-value : <.0001*/
...
proc freq data=b.total_final; where group=0;tables DS1_EDU1/list missing; run;/*1)고졸 미만 : 1973 2) 고졸 : 2115 3) 대졸 이상 : 1120 99: 61 */
proc freq data=b.total_final; where group=1;tables DS1_EDU1/list missing; run;/*1)고졸 미만 : 2015 2) 고졸 : 2010 3) 대졸 이상 : 1052 99: 142 */
proc freq data=b.total_final; where group=2;tables DS1_EDU1/list missing; run;/*1)고졸 미만 : 2110 2) 고졸 : 2022 3) 대졸 이상 : 1058 99: 73*/
proc freq data=b.total_final; tables DS1_EDU1*group/chisq; run;	/*p-value : <.0001*/
...
proc freq data=b.total_final; where group=0;tables DS1_INCOME1/list missing; run;/*1) 200만원 미만 : 1798 2) 200만원 이상 400만원 미만 : 1789 3) 400만원 이상 : 954 99 : 728*/ 
proc freq data=b.total_final; where group=1;tables DS1_INCOME1/list missing; run;/*1) 200만원 미만 : 1623 2) 200만원 이상 400만원 미만 : 1815 3) 400만원 이상 : 921 99 : 860 */ 
proc freq data=b.total_final; where group=2;tables DS1_INCOME1/list missing; run;/*1) 200만원 미만 : 1653 2) 200만원 이상 400만원 미만 : 1789 3) 400만원 이상 : 943 99 : 878 */ 
proc freq data=b.total_final; tables DS1_INCOME1*group/chisq; run; /*p-value : 0.0001*/

/****직업****/
 /*DS1_JOB_1; 주부나 무직(1), 직업있음(2)*/		
proc freq data=b.total_final; tables DS1_JOB*DS1_JOB_A*DS1_JOB_1; run;
proc freq data=b.total_final; where group=0;tables DS1_JOB_1/list missing; run; /*1)주부 혹은 무직 : 3149 2)직업있음 : 2005 99 : 115*/
proc freq data=b.total_final; where group=1;tables DS1_JOB_1/list missing; run;/*1)주부 혹은 무직 : 2698 2)직업있음 : 2340 99 : 181*/
proc freq data=b.total_final; where group=2;tables DS1_JOB_1/list missing; run;/*1)주부 혹은 무직 : 2892 2)직업있음 : 2212 99 : 159*/
proc freq data=b.total_final; tables DS1_JOB_1*group/chisq; run;	/*p-value : <.0001*/

/****흡연****/
/*csmok: 현재흡연 (1), 과거흡연& 경험없음(0)*/					
/*psmok: 현재흡연 (2), 과거흡연 (1), 경험없음 (0)*/		
proc freq data=b.total_final; where group=0; tables csmok*group/list missing; run; /*0) 과거흡연&경험없음 : 4962 1) 현재흡연 : 280 99 : 27 */
proc freq data=b.total_final; where group=1; tables csmok*group/list missing; run;/*0) 과거흡연&경험없음 : 4697 1) 현재흡연 : 444 99 : 78 */
proc freq data=b.total_final; where group=2; tables csmok*group/list missing; run;/*0) 과거흡연&경험없음 : 4825 1) 현재흡연 : 404 99 : 27 */
proc freq data=b.total_final; tables csmok*group/chisq; run;/*p-value : <.0001*/

proc freq data=b.total_final; where group=0; tables psmok*group/list missing; run;/*0) 경험없음 : 4143 1) 과거흡연 : 819 2) 현재흡연 : 280  99 : 27 */
proc freq data=b.total_final; where group=1; tables psmok*group/list missing; run;/*0) 경험없음 : 4142 1) 과거흡연 : 555 2) 현재흡연 : 444  99: 78 */
proc freq data=b.total_final; where group=2; tables psmok*group/list missing; run;/*0) 경험없음 : 4144 1) 과거흡연 : 681 2) 현재흡연 : 404  99: 34 */
proc freq data=b.total_final; tables psmok*group/chisq; run;/*p-value : <.0001*/
proc freq data=b.total_final; tables psmok*group/chisq; run;/*p-value : <.0001*/

/*****음주****/
/*cdrink: 현재음주(1), 현재음주안함(0)*/
/*pdrink: 현재음주 (2), 과거음주 (1), 경험없음 (0)*/		
proc freq data=b.total_final; where group=0;tables cdrink*group/list missing; run;/* 0) 음주안함 : 3802 1) 현재음주 : 1444 99: 23*/
proc freq data=b.total_final; where group=1;tables cdrink*group/list missing; run;/* 0) 음주안함 : 3151 1) 현재음주 : 1990 99: 78*/
proc freq data=b.total_final; where group=2;tables cdrink*group/list missing; run;/* 0) 음주안함 : 3207 1) 현재음주 : 2027 99: 78 */
proc freq data=b.total_final; tables cdrink*group/chisq; run;/*p-value : <.0001*/

proc freq data=b.total_final; where group=0;tables pdrink*group/list missing; run;/* 0) 경험없음 : 3275 1) 과거음주 : 527 2) 현재음주 : 1444 99: 23*/
proc freq data=b.total_final; where group=1;tables pdrink*group/list missing; run;/* 0) 경험없음 : 3019 1) 과거음주 : 132 2) 현재음주 :1990 99: 78: */
proc freq data=b.total_final; where group=2;tables pdrink*group/list missing; run;/* 0) 경험없음 : 3003 1) 과거음주 : 204 2) 현재음주 2027: 99: 29 */
proc freq data=b.total_final; tables pdrink*group/chisq; run;

/***운동**/	
/*gexer_wk1: 주 150분 미만 (1), 주 150분 이상 (2)*/
/*gexer_wk2: 운동안함(1), 주 150분 미만(2), 주 150분 이상(3)*/			
/*gexer_wk3: 운동안함(1), 운동함 (2)*/			
proc freq data=b.total_final; where group=0; tables gexer_wk2*group/list missing; run; /**1) 운동안함 : 2203) 2) 주 150분 미만 : 594 3) 주 150분 이상 : 2332 99 : 140**/
proc freq data=b.total_final; where group=1; tables gexer_wk2*group/list missing; run;  /**1) 운동안함 : 2530) 2) 주 150분 미만 : 605 3) 주 150분 이상  1838 99 : 246**/
proc freq data=b.total_final; where group=2; tables gexer_wk2*group/list missing; run; /**1) 운동안함 : 2470) 2) 주 150분 미만 : 630 3) 주 150분 이상 : 1987 99 : 176**/
proc freq data=b.total_final; tables gexer_wk2*group/chisq; run;/*p-value<0.001*/
...
proc freq data=b.total_final; where group=0;tables gbmi2/list missing; run;/*gbmi2: 1)23 미만 : 2308, 2)25 미만 : 1398 3)25이상 : 1544 99999 : 19 */
proc freq data=b.total_final; where group=1;tables gbmi2/list missing; run;/*gbmi2: 1)23 미만 : 2286, 2)25 미만 : 1455 3)25이상 : 1453 99999 : 25 */
proc freq data=b.total_final; where group=2;tables gbmi2/list missing; run;/*gbmi2: 1)23 미만 : 1914, 2)25 미만 : 1484 3)25이상 : 1848 99999 : 17 */
proc freq data=b.total_final; tables gbmi2*group/chisq; run; /*p-value : 0.0001*/
...
run;
proc univariate data=b.total_final ; where PWI^=99999; class group; var PWI; run;
proc anova data=b.total_final; where PWI^=99999; class group; model PWI=group; MEANS group / DUNCAN ;run; quit;
...
run;
proc freq data=b.total_final; tables PWI_2*group/list missing; run;

proc freq data=b.total_final; tables pwi*pwi_1/list missing; run;
proc freq data=b.total_final; tables pwi*group/chisq;run;	/*p-value : <.0001*/
proc freq data=b.total_final; tables PWI_1; run;/*1)정상 : 1657 2) 약간 스트레스 : 11635 3) 매우 심한 스트레스 : 1753 99999 : 706 */                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
proc freq data=b.total_final; where group=0; tables PWI_1; run;/*1)정상 : 532 2) 약간 스트레스 : 3892 3) 매우 심한 스트레스 : 652 99999 : 193 */    
proc freq data=b.total_final; where group=1; tables PWI_1; run;/*1)정상 : 652 2) 약간 스트레스 : 3851 3) 매우 심한 스트레스 : 437 99999 : 279 */    
proc freq data=b.total_final; where group=2; tables PWI_1; run;/*1)정상 : 473 2) 약간 스트레스 : 3892 3) 매우 심한 스트레스 : 664 99999 : 234 */    
proc freq data=b.total_final; tables PWI_1*group/chisq; run;	/*p-value : <.0001*/
...
proc freq data=b.total_final; tables MeS * group/chisq; run;

proc freq data=b.total_final; where wc ^= 99; tables wc * group/chisq; run;

proc freq data=b.total_final; where tg ^= 99; tables tg * group/chisq; run;
proc univariate data=b.total_final; where tg ^= 99; class group; var ds1_tg1; run;
proc freq data=b.total_final; where hdl ^= 99; tables hdl * group/chisq; run;
proc univariate data=b.total_final; where hdl ^= 99; class group; var ds1_hdl1; run;
proc freq data=b.total_final; where bp ^= 99; tables bp * group/chisq; run;
proc univariate data=b.total_final; where bp ^= 99; class group; var ds1_dbp1; run;
proc univariate data=b.total_final; where bp ^= 99; class group; var ds1_sbp1; run;
proc freq data=b.total_final; where glu ^= 99; tables glu * group/chisq; run;
proc univariate data=b.total_final; where glu ^= 99; class group; var ds1_glu0_1; run;

proc univariate data=b.total_final; where cwaist ^= 99999; class group; var cwaist; run;
proc anova data=b.total_final; where cwaist ^= 99999; class group; model cwaist=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.total_final; where ds1_tg1^= 99999; class group; var ds1_tg1; run;
proc anova data=b.total_final; where ds1_tg1 ^= 99999; class group; model ds1_tg1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.total_final; where ds1_hdl1^= 99999; class group; var ds1_hdl1; run;
proc anova data=b.total_final; where ds1_hdl1 ^= 99999; class group; model ds1_hdl1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.total_final; where ds1_sbp1^= 99999; class group; var ds1_sbp1; run;
proc anova data=b.total_final; where ds1_sbp1 ^= 99999; class group; model ds1_sbp1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.total_final; where ds1_dbp1^= 99999; class group; var ds1_dbp1; run;
proc anova data=b.total_final; where ds1_dbp1 ^= 99999; class group; model ds1_dbp1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.total_final; where ds1_glu0_1^= 99999; class group; var ds1_glu0_1; run;
proc anova data=b.total_final; where ds1_glu0_1 ^= 99999; class group; model ds1_glu0_1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;

/****Chart : 전체 성별에 따라 흡연, 음주, 운동, 스트레스****/
/****(1) Smoke****/
proc freq data=b.total_final; where psmok^=99 and DS1_SEX1=1; tables psmok*group/chisq; run;
proc freq data=b.total_final; where psmok^=99 and DS1_SEX1=2; tables psmok*group/chisq; run;
/****(2) Drink****/
proc freq data=b.total_final; where pdrink^=99 and DS1_SEX1=1; tables pdrink*group/chisq; run;
proc freq data=b.total_final; where pdrink^=99 and DS1_SEX1=2; tables pdrink*group/chisq; run;
/****(3) Gexer****/
proc freq data=b.total_final; where gexer_wk2^=99 and DS1_SEX1=1; tables gexer_wk2*group/chisq; run;
proc freq data=b.total_final; where gexer_wk2^=99 and DS1_SEX1=2; tables gexer_wk2*group/chisq; run;
/****(4) Gbmi2****/
proc freq data=b.total_final; where gbmi2^=99999 and DS1_SEX1=1; tables gbmi2*group/chisq; run;
proc freq data=b.total_final; where gbmi2^=99999 and DS1_SEX1=2; tables gbmi2*group/chisq; run;
/****(5) pwi_1****/
proc freq data=b.total_final; where pwi_1^=99999 and DS1_SEX1=1; tables pwi_1*group/chisq; run;
proc freq data=b.total_final; where pwi_1^=99999 and DS1_SEX1=2; tables pwi_1*group/chisq; run;
/****(6) Totalkcal****/
proc freq data=b.total_final; where Totalkcal^=9999; tables Totalkcal*group/chisq; run;
proc freq data=b.total_final; where Totalkcal^=9999 and DS1_SEX1=1; tables Totalkcal*group/chisq; run;
proc freq data=b.total_final; where Totalkcal^=9999 and DS1_SEX1=2; tables Totalkcal*group/chisq; run;
/****(7) MeS****/
proc freq data=b.total_final; where DS1_SEX1=1; tables MeS*group/chisq; run;
proc freq data=b.total_final; where DS1_SEX1=2; tables MeS*group/chisq; run;
/****(8) WC****/
proc freq data=b.total_final; where wc ^= 99 and DS1_SEX1=1; tables wc*group/chisq; run;
proc freq data=b.total_final; where wc ^= 99 and DS1_SEX1=2; tables wc*group/chisq; run;
/****(9) TG****/
proc freq data=b.total_final; where TG ^= 99 and DS1_SEX1=1; tables TG*group/chisq; run;
proc freq data=b.total_final; where TG ^= 99 and DS1_SEX1=2; tables TG*group/chisq; run;
/****(10) HDL****/
proc freq data=b.total_final; where HDL ^= 99 and DS1_SEX1=1; tables HDL*group/chisq; run;
proc freq data=b.total_final; where HDL ^= 99 and DS1_SEX1=2; tables HDL*group/chisq; run;
/****(11) BP****/
proc freq data=b.total_final; where BP ^= 99 and DS1_SEX1=1; tables BP*group/chisq; run;
proc freq data=b.total_final; where BP ^= 99 and DS1_SEX1=2; tables BP*group/chisq; run;
/****(12) GLU****/
proc freq data=b.total_final; where GLU ^= 99 and DS1_SEX1=1; tables GLU*group/chisq; run;
proc freq data=b.total_final; where GLU ^= 99 and DS1_SEX1=2; tables GLU*group/chisq; run;
...
run;
proc freq data=b.total_final; tables group2; run;
...
data b.total_final; set b.total_final;  
	 ...
	 drop t1 - t10;
run;
proc freq data=b.total_final; where energy^=99999; tables energy*group/chisq; run;

/* energy 변수를 제외하고 김명관 선생님이 만들어 놓은 변수들을 활용함*/

/****Data Review : Nutrition****/
proc freq data=b.total_final; where energy^=99999; tables energy*group/chisq; run;
proc freq data=b.total_final; where protein^=99999; tables protein*group/chisq; run;
proc freq data=b.total_final; where fat^=99999; tables fat*group/chisq; run;
proc freq data=b.total_final; where sugar^=99999; tables sugar*group/chisq; run;
proc freq data=b.total_final; where fiber^=99999; tables fiber*group/chisq; run;
proc freq data=b.total_final; where VitA^=99999; tables VitA*group/chisq; run;
proc freq data=b.total_final; where VitB1^=99999; tables VitB1*group/chisq; run;
proc freq data=b.total_final; where VitB2^=99999; tables VitB2*group/chisq; run;
proc freq data=b.total_final; where Niacin^=99999; tables Niacin*group/chisq; run;
proc freq data=b.total_final; where Folate^=99999; tables Folate*group/chisq; run;
proc freq data=b.total_final; where VitB6^=99999; tables VitB6*group/chisq; run;
proc freq data=b.total_final; where VitC^=99999; tables VitC*group/chisq; run;
proc freq data=b.total_final; where VitE^=99999; tables VitE*group/chisq; run;
proc freq data=b.total_final; where Cals^=99999; tables Cals*group/chisq; run;
proc freq data=b.total_final; where pho^=99999; tables pho*group/chisq; run;
proc freq data=b.total_final; where iron^=99999; tables iron*group/chisq; run;
proc freq data=b.total_final; where Cal^=99999; tables Cal*group/chisq; run;
proc freq data=b.total_final; where Zinc^=99999; tables Zinc*group/chisq; run;
proc freq data=b.total_final; where Na^=99999; tables Na*group/chisq; run;

/*Nutrtion Univariate*/
proc univariate data=b.total_final ; where SS01^=99999; class group; var SS01; run;
proc univariate data=b.total_final ; where SS02^=99999; class group; var SS02; run;
proc univariate data=b.total_final ; where protein^=99999; class group; var protein_percent; run;
proc univariate data=b.total_final ; where SS03^=99999; class group; var SS03; run;
proc univariate data=b.total_final ; where fat^=99999; class group; var fat_percent; run;
proc univariate data=b.total_final ; where SS04^=99999; class group; var SS04; run;
proc univariate data=b.total_final ; where sugar^=99999; class group; var sugar_percent; run;
proc univariate data=b.total_final ; where SS21^=99999; class group; var SS21; run;
proc univariate data=b.total_final ; where SS09^=99999; class group; var SS09; run;
proc univariate data=b.total_final ; where SS11^=99999; class group; var SS11; run;
proc univariate data=b.total_final ; where SS12^=99999; class group; var SS12; run;
proc univariate data=b.total_final ; where SS13^=99999; class group; var SS13; run;
proc univariate data=b.total_final ; where SS17^=99999; class group; var SS17; run;
proc univariate data=b.total_final ; where SS16^=99999; class group; var SS16; run;
proc univariate data=b.total_final ; where SS14^=99999; class group; var SS14; run;
proc univariate data=b.total_final ; where SS23^=99999; class group; var SS23; run;
proc univariate data=b.total_final ; where SS05^=99999; class group; var SS05; run;
proc univariate data=b.total_final ; where SS06^=99999; class group; var SS06; run;
proc univariate data=b.total_final ; where SS07^=99999; class group; var SS07; run;
proc univariate data=b.total_final ; where SS08^=99999; class group; var SS08; run;
proc univariate data=b.total_final ; where SS15^=99999; class group; var SS15; run;
proc univariate data=b.total_final ; where SS10^=99999; class group; var SS10; run;

/*****Nutrition ANOVA****/
proc anova data=b.total_final; where SS01^=99999; class group; model SS01=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS02^=99999; class group; model SS02=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where protein_percent^=99999; class group; model protein_percent=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS03^=99999; class group; model SS03=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where fat_percent^=99999; class group; model fat_percent=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS04^=99999; class group; model SS04=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where sugar_percent^=99999; class group; model sugar_percent=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS21^=99999; class group; model SS21=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS09^=99999; class group; model SS09=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS11^=99999; class group; model SS11=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS12^=99999; class group; model SS12=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS13^=99999; class group; model SS13=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS17^=99999; class group; model SS17=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS16^=99999; class group; model SS16=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS14^=99999; class group; model SS14=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS23^=99999; class group; model SS23=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS05^=99999; class group; model SS05=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS06^=99999; class group; model SS06=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS07^=99999; class group; model SS07=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS08^=99999; class group; model SS08=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS15^=99999; class group; model SS15=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.total_final; where SS10^=99999; class group; model SS10=group; MEANS group / DUNCAN ;run;quit;
...
/*******Data Reveiw by Cancer Type *******/
proc freq data=b.total_final; tables CANCER_TYPE*group/list missing;run;

data b.total_final; set b.total_final;    /* cancer_type2 변수를 새로 생성, 암 생존자 집단이 아니거나(group=1, 2) 암 생존자이나 암종 정보가 없는 경우(239명)를 모두 Missing으로 처리*/
	if CANCER_TYPE = . then cancer_type2 = 99999;
	else if CANCER_TYPE = 0 then cancer_type2 = 99999;
	else cancer_type2 = CANCER_TYPE;
run;
proc freq data=b.total_final; tables cancer_type2*group/list missing;run;
proc freq data=b.total_final; tables cancer_type2/list missing;run;

proc freq data=b.total_final; where group=0 and cancer_type2^=99999; tables cancer_type2*DS1_SEX1/chisq;run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and psmok^=99; tables cancer_type2*psmok/chisq;run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and pdrink^=99; tables cancer_type2*pdrink/chisq;run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and gexer_wk2^=99; tables cancer_type2*gexer_wk2/chisq;run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and gbmi2^=99999; tables cancer_type2*gbmi2/chisq;run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and PWI_1^=99999; tables cancer_type2*PWI_1/chisq;run;

proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and energy^=99999; tables cancer_type2*energy/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and protein^=99999; tables cancer_type2*protein/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and fat^=99999; tables cancer_type2*fat/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and sugar^=99999; tables cancer_type2*sugar/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and fiber^=99999; tables cancer_type2*fiber/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and VitA^=99999; tables cancer_type2*VitA/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and VitE^=99999; tables cancer_type2*VitE/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and VitC^=99999; tables cancer_type2*VitC/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and VitB1^=99999; tables cancer_type2*VitB1/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and VitB2^=99999; tables cancer_type2*VitB2/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and Niacin^=99999; tables cancer_type2*Niacin/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and VitB6^=99999; tables cancer_type2*VitB6/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and Folate^=99999; tables cancer_type2*Folate/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and Cals^=99999; tables cancer_type2*Cals/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and pho^=99999; tables cancer_type2*pho/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and Na^=99999; tables cancer_type2*Na/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and Cal^=99999; tables cancer_type2*Cal/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and iron^=99999; tables cancer_type2*iron/chisq; run;
proc freq data=b.total_final; where group=0 and cancer_type2^=99999 and Zinc^=99999; tables cancer_type2*Zinc/chisq; run;
...
proc logistic data=b.total_final; where csmok not in (99);    
    ...
    model csmok (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where cdrink not in (99);    
	...
	model cdrink (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1;
...
proc logistic data=b.total_final; where gexer_wk1 not in (99);    
    ...
    model gexer_wk1 (ref='1') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where gbmi1 not in (99999);    
    ...
    model gbmi1 (ref='1') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where PWI_2 not in (99999);    
    ...
    model PWI_2 (ref='1') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final;    
    ...
    model MeS (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.total_final; where wc not in (99);    
    ...
    model wc (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where tg not in (99);    
    ...
    model tg (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where hdl not in (99);    
    ...
    model hdl (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where bp not in (99);    
    ...
    model bp (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where glu not in (99);    
    ...
    model glu (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where energy not in (99999);    
    ...
    model energy (ref='1') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where protein not in (99999);    
    ...
    model protein (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where fat_2 not in (99999);    
    ...
    model fat_2 (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where sugar_2 not in (99999);    
    ...
    model sugar_2 (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where fiber not in (99999);    
    ...
    model fiber (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where VitA not in (99999);    
    ...
    model VitA (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where VitB1 not in (99999);    
    ...
    model VitB1 (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where VitB2 not in (99999);    
    ...
    model VitB2 (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where Niacin not in (99999);    
    ...
    model Niacin (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where Folate not in (99999);    
    ...
    model Folate (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where VitB6 not in (99999);    
    ...
    model VitB6 (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where VitC not in (99999);    
    ...
    model VitC (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where VitE not in (99999);    
    ...
    model VitE (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where Cals not in (99999);    
    ...
    model Cals (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where pho not in (99999);    
    ...
    model pho (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where iron not in (99999);  
    ...
    model iron (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where Cal not in (99999);    
    ...
    model Cal (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where Zinc not in (99999);    
    ...
    model Zinc (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where Na not in (99999);   
    ...
    model Na (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 PWI_2 energy DS1_SRH_1 DS1_FCA_1; 
...
proc logistic data=b.total_final; where DS1_SEX1=1;
    ...
    model MeS (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1; 
...
/****Group(0, 1, 2) 확인****0 : 암 생존자 1: 질환x 일반 2: 질환0 일반**/
data b.com; set a.com_frequency; run;

proc contents data=b.com; run;
proc freq data=b.com; tables group/list missing; run;
...
proc freq data=b.com; tables cage_2*group/chisq; run;
/***나이(평균 및 표준편차)***/
proc univariate data=b.com ; class group; var cage; run;
proc anova data=b.com; class group; model cage=group; MEANS group / DUNCAN ;run;

/****성별****/
proc freq data=b.com;  tables DS1_SEX1*group/chisq; run;

/*DS1_MARRY_A_1; 미혼/별거/이혼/사별/기타 (1), 기혼/동거=결혼(2), */		
proc freq data=b.com; tables DS1_MARRY_A_1*group/chisq; run;
...
proc freq data=b.com; tables DS1_EDU1*group/chisq; run;		

/****수입****/
/* 1=50만원 미만, 2=50-100만원 미만, 3=100-150만원 미만, 4=150-200만원 미만, 5=200-300만원 미만, 6=300-400만원 미만, 7=400-600만원 미만, 8=600만원 이상 		
 if DS1_INCOME in ('1','2','3','4') then DS1_INCOME1=1; else if DS1_INCOME in ('5','6') then DS1_INCOME1=2; else if DS1_INCOME in ('7','8') then DS1_INCOME1=3; 
else if DS1_INCOME in ('66666','99999') then DS1_INCOME1=99;*/
proc freq data=b.com; tables DS1_INCOME1*group/chisq; run;

/*DS1_JOB_1; 주부나 무직(1), 직업있음(2)*/		
proc freq data=b.com; tables DS1_JOB_1*group/chisq; run;	

/*흡연 변수 정리-gastric cancer*/					
/*csmok: 현재흡연 (1), 과거흡연& 경험없음(0)*/					
/*psmok: 현재흡연 (2), 과거흡연 (1), 경험없음 (0)*/		
proc freq data=b.com; tables psmok*group/chisq; run;

/****그룹 별 음주변수 정리****/
/*cdrink: 현재음주(1), 현재음주안함(0)*/				
/*pdrink: 현재음주 (2), 과거음주 (1), 경험없음 (0)*/		
proc freq data=b.com;tables pdrink*group/chisq; run;
...
/*gexer_wk2: 운동안함(1), 주 150분 미만(2), 주 150분 이상(3)*/			
/*gexer_wk3: 운동안함(1), 운동함 (2)*/			
proc freq data=b.com; tables gexer_wk2*group/chisq; run;
...
proc freq data=b.com;  tables gbmi2*group/chisq; run;
...
proc univariate data=b.com ; where PWI^=99999; class group; var pwi; run;
proc anova data=b.com; where PWI^=99999; class group; model PWI=group; MEANS group / DUNCAN ;run;
...
proc freq data=b.com; where group=0;tables PWI_1; run;
proc freq data=b.com; where group=1;tables PWI_1; run;
proc freq data=b.com; where group=2;tables PWI_1; run;
proc freq data=b.com; tables PWI_1*group/chisq; run;	
...
run;
proc freq data=b.com; tables PWI_2*group/list missing; run;
...
proc freq data=b.com; tables MeS * group/chisq; run;

proc freq data=b.com; where wc ^= 99; tables wc * group/chisq; run;
proc univariate data=b.com; where wc ^= 99; class wc; var cwaist; run;
proc freq data=b.com; where tg ^= 99; tables tg * group/chisq; run;
proc univariate data=b.com; where tg ^= 99; class tg; var ds1_tg1; run;
proc freq data=b.com; where hdl ^= 99; tables hdl * group/chisq; run;
proc univariate data=b.com; where hdl ^= 99; class hdl; var ds1_hdl1; run;
proc freq data=b.com; where bp ^= 99; tables bp * group/chisq; run;
...
proc freq data=b.com; where glu ^= 99; tables glu * group/chisq; run;
proc univariate data=b.com; where glu ^= 99; class glu; var ds1_glu0_1; run;

proc univariate data=b.com; where cwaist ^= 99999; class group; var cwaist; run;
proc anova data=b.com; where cwaist ^= 99999; class group; model cwaist=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.com; where ds1_tg1^= 99999; class group; var ds1_tg1; run;
proc anova data=b.com; where ds1_tg1 ^= 99999; class group; model ds1_tg1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.com; where ds1_hdl1^= 99999; class group; var ds1_hdl1; run;
proc anova data=b.com; where ds1_hdl1 ^= 99999; class group; model ds1_hdl1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.com; where ds1_sbp1^= 99999; class group; var ds1_sbp1; run;
proc anova data=b.com; where ds1_sbp1 ^= 99999; class group; model ds1_sbp1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.com; where ds1_dbp1^= 99999; class group; var ds1_dbp1; run;
proc anova data=b.com; where ds1_dbp1 ^= 99999; class group; model ds1_dbp1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;
proc univariate data=b.com; where ds1_glu0_1^= 99999; class group; var ds1_glu0_1; run;
proc anova data=b.com; where ds1_glu0_1 ^= 99999; class group; model ds1_glu0_1=group; MEANS group / DUNCAN ;run;/*Duncan Grouping : 세 그룹 모두 A */ quit;

/****Chart : 전체 성별에 따라 흡연, 음주, 운동, 스트레스****/
/****(1) Smoke****/
proc freq data=b.com; where psmok^=99 and DS1_SEX1=1; tables psmok*group/chisq; run;
proc freq data=b.com; where psmok^=99 and DS1_SEX1=2; tables psmok*group/chisq; run;
/****(2) Drink****/
proc freq data=b.com; where pdrink^=99 and DS1_SEX1=1; tables pdrink*group/chisq; run;
proc freq data=b.com; where pdrink^=99 and DS1_SEX1=2; tables pdrink*group/chisq; run;
/****(3) Gexer****/
proc freq data=b.com; where gexer_wk2^=99 and DS1_SEX1=1; tables gexer_wk2*group/chisq; run;
proc freq data=b.com; where gexer_wk2^=99 and DS1_SEX1=2; tables gexer_wk2*group/chisq; run;
/****(4) Gbmi2****/
proc freq data=b.com; where gbmi2^=99999 and DS1_SEX1=1; tables gbmi2*group/chisq; run;
proc freq data=b.com; where gbmi2^=99999 and DS1_SEX1=2; tables gbmi2*group/chisq; run;
/****(5) pwi_1****/
proc freq data=b.com; where pwi_1^=99999 and DS1_SEX1=1; tables pwi_1*group/chisq; run;
proc freq data=b.com; where pwi_1^=99999 and DS1_SEX1=2; tables pwi_1*group/chisq; run;
/****(6) Totalkcal****/
proc freq data=b.com; tables Totalkcal*group/chisq; run;
proc freq data=b.com; where Totalkcal^=9999 and DS1_SEX1=1; tables Totalkcal*group/chisq; run;
proc freq data=b.com; where Totalkcal^=9999 and DS1_SEX1=2; tables Totalkcal*group/chisq; run;
/****(7) MeS****/
proc freq data=b.com; where DS1_SEX1=1; tables MeS*group/chisq; run;
proc freq data=b.com; where DS1_SEX1=2; tables MeS*group/chisq; run;
/****(8) WC****/
proc freq data=b.com; where wc ^= 99 and DS1_SEX1=1; tables wc*group/chisq; run;
proc freq data=b.com; where wc ^= 99 and DS1_SEX1=2; tables wc*group/chisq; run;
/****(9) TG****/
proc freq data=b.com; where TG ^= 99 and DS1_SEX1=1; tables TG*group/chisq; run;
proc freq data=b.com; where TG ^= 99 and DS1_SEX1=2; tables TG*group/chisq; run;
/****(10) HDL****/
proc freq data=b.com; where HDL ^= 99 and DS1_SEX1=1; tables HDL*group/chisq; run;
proc freq data=b.com; where HDL ^= 99 and DS1_SEX1=2; tables HDL*group/chisq; run;
/****(11) BP****/
proc freq data=b.com; where BP ^= 99 and DS1_SEX1=1; tables BP*group/chisq; run;
proc freq data=b.com; where BP ^= 99 and DS1_SEX1=2; tables BP*group/chisq; run;
/****(12) GLU****/
proc freq data=b.com; where GLU ^= 99 and DS1_SEX1=1; tables GLU*group/chisq; run;
proc freq data=b.com; where GLU ^= 99 and DS1_SEX1=2; tables GLU*group/chisq; run;
...
run;
proc freq data=b.com; tables group2; run;
...
data b.com; set b.com;  
	 ...
	 drop t1 - t10;
run;
proc freq data=b.com; where energy^=99999; tables energy*group/chisq; run;
...
run;
proc freq data=b.com; where Protein^=99999; tables Protein*group/chisq; run;
...
run;
proc freq data=b.com; where fat^=99999; tables fat*group/chisq; run;
...
run;	
proc freq data=b.com; where sugar^=99999; tables sugar*group/chisq; run;
data b.com; set b.com;
    if sugar in (., 99999) then sugar_2=99999;
	else if sugar < 2 then sugar_2=0;
	else sugar_2=1;
...
run;
proc freq data=b.com; where sugar_2^=99999; tables sugar_2*group/chisq;run;
proc freq data=b.com; where fat_2^=99999; tables fat_2*group/chisq;run;
...
proc freq data=b.com; where Fiber^=99999; tables Fiber*group/chisq; run;
...
data b.com; set b.com;
	...
	drop t1-t10;
run;
proc freq data=b.com; where VitA^=99999; tables VitA*group/chisq; run;
...
data b.com; set b.com;
	 ...
	 drop t1 - t10;
run;
proc freq data=b.com; where VitB1^=99999; tables VitB1*group/chisq; run;
...
data b.com; set b.com;
	 ...
	 drop t1 - t10;
run;
proc freq data=b.com; where VitB2^=99999; tables VitB2*group/chisq; run;
...
/*(11) 니아신*/
 data b.com; set b.com;
	...
	drop t1-t10;
run;
proc freq data=b.com; where Niacin^=99999; tables Niacin*group/chisq; run;
...
run;
proc freq data=b.com; where Folate^=99999; tables Folate*group/chisq; run;
...
data b.com; set b.com;
	...
	drop t1-t10;
run;
proc freq data=b.com; where VitB6^=99999; tables VitB6*group/chisq; run;
...
run;
proc freq data=b.com; where VitC^=99999; tables VitC*group/chisq; run;
...
run; 
proc freq data=b.com; where VitE^=99999; tables VitE*group/chisq; run;
...
data b.com; set b.com;
	...
	drop t1-t10;
run;
proc freq data=b.com; where cals^=99999; tables cals*group/chisq; run;
...
run; 
proc freq data=b.com; where pho^=99999; tables pho*group/chisq; run;
...
data b.com; set b.com;
	...
	drop t1-t10;
run; 
proc freq data=b.com; where iron^=99999; tables iron*group/chisq; run;
...
run;
proc freq data=b.com; where Cal^=99999; tables Cal*group/chisq; run;
...
data b.com; set b.com;
	...
	drop t1-t10;
run;
proc freq data=b.com; where Zinc^=99999; tables Zinc*group/chisq; run;
...
data b.com; set b.com;
	...
	drop t1-t10;
run;
proc freq data=b.com; where Na^=99999; tables Na*group/chisq; run;

/*Nutrtion Univariate*/
proc univariate data=b.com ; where SS01^=99999; class group; var SS01; run;
proc univariate data=b.com ; where SS02^=99999; class group; var SS02; run;
proc univariate data=b.com ; where protein^=99999; class group; var protein_percent; run;
proc univariate data=b.com ; where SS03^=99999; class group; var SS03; run;
proc univariate data=b.com ; where fat^=99999; class group; var fat_percent; run;
proc univariate data=b.com ; where SS04^=99999; class group; var SS04; run;
proc univariate data=b.com ; where sugar^=99999; class group; var sugar_percent; run;
proc univariate data=b.com ; where SS21^=99999; class group; var SS21; run;
proc univariate data=b.com ; where SS09^=99999; class group; var SS09; run;
proc univariate data=b.com ; where SS11^=99999; class group; var SS11; run;
proc univariate data=b.com ; where SS12^=99999; class group; var SS12; run;
proc univariate data=b.com ; where SS13^=99999; class group; var SS13; run;
proc univariate data=b.com ; where SS17^=99999; class group; var SS17; run;
proc univariate data=b.com ; where SS16^=99999; class group; var SS16; run;
proc univariate data=b.com ; where SS14^=99999; class group; var SS14; run;
proc univariate data=b.com ; where SS23^=99999; class group; var SS23; run;
proc univariate data=b.com ; where SS05^=99999; class group; var SS05; run;
proc univariate data=b.com ; where SS06^=99999; class group; var SS06; run;
proc univariate data=b.com ; where SS07^=99999; class group; var SS07; run;
proc univariate data=b.com ; where SS08^=99999; class group; var SS08; run;
proc univariate data=b.com ; where SS15^=99999; class group; var SS15; run;
proc univariate data=b.com ; where SS10^=99999; class group; var SS10; run;

/*****Nutrition ANOVA****/
proc anova data=b.com; where SS01^=99999; class group; model SS01=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS02^=99999; class group; model SS02=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where protein_percent^=99999; class group; model protein_percent=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS03^=99999; class group; model SS03=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where fat_percent^=99999; class group; model fat_percent=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS04^=99999; class group; model SS04=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where sugar_percent^=99999; class group; model sugar_percent=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS21^=99999; class group; model SS21=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS09^=99999; class group; model SS09=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS11^=99999; class group; model SS11=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS12^=99999; class group; model SS12=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS13^=99999; class group; model SS13=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS17^=99999; class group; model SS17=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS16^=99999; class group; model SS16=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS14^=99999; class group; model SS14=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS23^=99999; class group; model SS23=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS05^=99999; class group; model SS05=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS06^=99999; class group; model SS06=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS07^=99999; class group; model SS07=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS08^=99999; class group; model SS08=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS15^=99999; class group; model SS15=group; MEANS group / DUNCAN ;run;quit;
proc anova data=b.com; where SS10^=99999; class group; model SS10=group; MEANS group / DUNCAN ;run;quit;


/*******Data Reveiw by Cancer Type *******/
proc freq data=b.com; tables CANCER_TYPE*group/list missing;run;

data b.com; set b.com;    /* cancer_type2 변수를 새로 생성, 암 생존자 집단이 아니거나(group=1, 2) 암 생존자이나 암종 정보가 없는 경우(239명)를 모두 Missing으로 처리*/
...
proc freq data=b.com; tables cancer_type2*group/list missing;run;;
...
proc logistic data=b.com; where wc not in (99) and DS1_SEX1=2;
    ...
    model wc (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.com; where tg not in (99) and DS1_SEX1=2;
    ...
    model tg (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.com; where hdl not in (99) and DS1_SEX1=2;
    ...
    model hdl (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.com; where bp not in (99) and DS1_SEX1=2;
    ...
    model bp (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
proc logistic data=b.com; where glu not in (99) and DS1_SEX1=2;
    ...
    model glu (ref='0') = group DS1_MARRY_A_1 DS1_EDU1 DS1_INCOME1 DS1_JOB_1 csmok cdrink gexer_wk1 gbmi1 energy DS1_SRH_1 DS1_FCA_1 DS1_ORALCON_1 DS1_MENYN_1; 
...
data b.cancer_only; set b.thesis;
	if group = 0 then output b.cancer_only;
run;
